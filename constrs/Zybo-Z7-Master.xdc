...
#set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports {inputs_base[4]}]
#set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports {inputs_base[5]}]
#set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports {inputs_base[6]}]
#set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports {inputs_base[7]}]
#set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS33} [get_ports {inputs_base[8]}]
#set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports {inputs_base[9]}]
#set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports {inputs_base[10]}]
#set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports {inputs_base[11]}]


##Pmod Header JC
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports rxd]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports txd]
...
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports rxd_pmu]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports txd_pmu]
